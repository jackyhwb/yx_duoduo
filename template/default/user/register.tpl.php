...
<table width="680" border="0" align="left" cellpadding="0" cellspacing="0">
		...
		<tr>
		  <td height="55" align="right" >淘宝账号/订单号 *&nbsp;&nbsp;</td>
		  <td><input name="tbnick" type="text" id="tbnick"  value="<?php if($web=='tb'){echo $default_name;}?>"  class="ddinput"/></td>
		  <td><label class="field_notice">您常用的淘宝账号或订单号 <?php if($webset['jiaocheng']['tbnick']!=''){?><a href="<?=$webset['jiaocheng']['tbnick']?>" target="_blank" style="color:#F00">如何填？</a><?php }?></label><label id="checking_tbnick" class="checking">检查中...</label></td>
		</tr>
        <?php }?>
