    	...
    	<div class="adminmain">
            ...
            <div class="c_border" style="border-top-style:solid; border-top-width:2px;padding-top:10px;">
                ...
                <input type="hidden" name="mod" value="user" /><input type="hidden" name="act" value="tradelist" />
                  ...
                  <select name="do" style="margin-left:10px;font-size:12px;"><option value="lost">淘宝订单</option><option value="paipailost">拍拍订单</option><option value="malllost">商城订单</option></select><input class="admin_searchx_b c_bgcolor" type="submit" value="查找遗漏订单" style="margin-left:10px; font-size:12px;" /></form>
                </div>
                <div class="admin_xfl">
                    <ul>
                    ...
                    <li id="task"><a href="<?=u('user','tradelist',array('do'=>'task'))?>">我的任务订单</a> </li>
                    <?php }?>
