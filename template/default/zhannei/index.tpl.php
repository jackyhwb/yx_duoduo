...
<div class="taoshihui">
            <div class="lay-1000-auto">
                <div class="tsh_tabmain">
					...
					<div class="megas512" style="padding:10px; display:none"><?php if($ddgoods_total==1){?><?=pageft($total,$pagesize*(1+$ajax_load_num),u(MOD,ACT,$url_arr),0)?><?php }?></div>
                </div>
            </div>
        </div>
