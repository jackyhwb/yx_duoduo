        ...
        <div id="J-zdm-article" class="zdm-article" data-pagename="index">
          ...
          <div id="J_zdm_list">
              <div class="zdm-list-item J-item-wrap item-no-expired" data-id="<?=$goods['id']?>" style="position:relative">
                <h4 class="t"><a class="J-item-track nodelog" target="_blank" href="<?=$goods['jump']?>" ><?=$goods['title']?></a></h4>
                <div class="item-img">
                  <a href="<?=$goods['jump']?>" target="_blank" class="J-item-track img nodelog" ><?=dd_html_img($goods['img'],$goods['title'],210)?></a>
                  <a href="<?=$goods['jump']?>" target="_blank" class="btn-zdm-goshop J-item-track nodelog" >去购买</a>
                </div>
