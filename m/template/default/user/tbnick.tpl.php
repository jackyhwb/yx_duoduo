...
<div class="info" style="border-top:none;">
  ...
  <form onSubmit="return checkForm($(this),cbCheckForm)" action="">
	...
	<dl <?php if($v){?>id="tbnick_tr_<?=$k?>"<?php }?> style=" width:35em">
     <dd style=" width:7.5em; font-size:1em; height:1em; display:inline-block;">淘宝账号/订单号</dd>          
 	<dt><input name="tbnick[<?=$k?>]" type="text" id="tbnick_<?=$k?>" value="<?=$v?>" style=" width:10em; padding:0 0.5em; margin-left:0.5em;" placeholder="淘宝账号/订单号"></dt>
