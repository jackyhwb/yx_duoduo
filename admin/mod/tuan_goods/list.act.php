...
$row=$duoduo->select_all('tuan_goods as a,mall as b','a.*,b.title as mallname','a.`title` like "%'.$q.'%" and a.mall_id=b.id'.$where.' order by '.$by.' sort asc,id desc limit '.$frmnum.','.$pagesize);
