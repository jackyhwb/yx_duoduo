...
<div style="float:left; width:340px; margin-left:30px">
                  ...
                  <div style=" height:250px; font-size:14px; width:150px; line-height:25px" class="zhushi">注意：美团，拉手带有城市api的网站，需要在保存商城后，修改网站，点击生成城市缓存，否则无法采集！</div>
                  ...
                  <div style="float:left;margin-left:10px">
                  <div style=" height:250px; font-size:14px; width:150px; line-height:25px" class="zhushi">选中商城，删除此商城的团购商品。</div>
