...
if($_GET['ck']==1){
	$today=$_GET['today'];
	$url=SITEURL.'/data/backstage.php?set_today='.$today;
	only_send($url);
	sleep(3);
...
<table id="addeditable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
  ...
  <tr>
    ...
    <td>&nbsp;<?=html_radio(array(0=>'不可用',1=>'可用'),BACKSTAGE,'BACKSTAGE')?> <span class="zhushi" style="cursor:pointer" id="checkBackStage" onclick="checkBackStage()">检测</span></td>
  </tr>
  <tr>
