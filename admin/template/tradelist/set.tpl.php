...
<table id="addeditable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
  ...
  <tr>
    ...
    <td>&nbsp;<input name="TDJ_URL" value="<?=defined('TDJ_URL')?TDJ_URL:SITEURL?>" style="width:250px;"/>&nbsp;<span class="zhushi">应为当前网址，如被扣分更换请看 <a href="http://bbs.duoduo123.com/read-1-1-198077.html" target="_blank">更换教程</a></td>
  </tr>
  <tr>
     <td align="right">&nbsp;</td>
