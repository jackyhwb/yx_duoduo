...
function act_huodong_list($pagesize=10,$field='a.id,a.sdate,a.edate,a.title,a.img,a.desc,a.mall_id,a.relate_id,b.title as mallname,b.fan,b.img as logo'){
	...
	$total=$duoduo->count('huodong as a,'.$mall_table_name.' as b','a.title like "%'.$q.'%" and a.mall_id=b.id');
	$huodong=$duoduo->select_all('huodong as a,'.$mall_table_name.' as b',$field, "a.title like '%".$q."%' and a.mall_id=b.id order by a.sort asc,a.id desc limit $frmnum,$pagesize");
